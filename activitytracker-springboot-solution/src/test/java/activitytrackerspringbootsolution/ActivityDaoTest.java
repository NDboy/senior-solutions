...
class ActivityDaoTest {
    ...
    void testSaveAndFindActivity() {
        ...
        assertThat(foundActivity)
                .hasToString(String.format("Activity{id=%d, startTime=2020-10-10T10:10, descr='single activity', type=HIKING}", id));


        assertThat(List.of(foundActivity))
                .extracting("id", "startTime", "descr", "type")
                .contains(tuple(id, LocalDateTime.of(2020,10, 10, 10, 10), "single activity", ActivityType.HIKING));
    ...
    void testSetDataById() {
        ...
        assertThat(activityDao.findActivityById(id))
                .hasToString(String.format("Activity{id=%d, startTime=2020-10-10T10:10, descr='!!!fake activity!!!', type=BASKETBALL}", id));
